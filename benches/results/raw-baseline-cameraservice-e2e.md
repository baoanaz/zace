...
|---|---|---|---|---|---|
| cameraservice-0001 | zh | symbol | 摄像头通道切换的状态机类在哪个头文件里？ | cameraservice/stateMc/MWPStateMcManager.h#MWPStateMcManager | common/Constants.h:235-235 (CFG_PARK_CAMERA_STS_BIT) / Data/MWPCameraData.h:23-57 (MWPCameraDataMgr::CameraParamsData) / CLAUDE.md:1-236 (linux-mtk-mw-cameraservice 仓库架构概述 > 关键类) |
...
| cameraservice-0006 | en | symbol | Which class parses CAN bus frames and dispatches speed/gear changes to listeners? | cameraservice/policy/can/MWPCanInfo.h#MWPCanInfo | .claude/skills/cviauto-meta/references/platform-files/agents.md:73-79 (Agents > Modification Principles) / README.md:47-92 (Editing this README > Contributing) / common/socket/MWPSocket.h:46-47 (MWPSocket) |
| cameraservice-0008 | en | spec | What processes make up this repository's two-process architecture and how do they communicate? | CLAUDE.md | .claude/skills/cviauto-spec-bootstrap/references/repository-analysis.md:13-24 (Repository Analysis > What To Capture) / .claude/skills/cviauto-update-spec/SKILL.md:95-284 (Update Code-Spec - Capture Executable Contracts > Update Process > Step 2: Classify the Update Type) / .claude/skills/cviauto-session-insight/references/triggering-patterns.md:1-93 (Triggering Patterns > Finish-work retrospective (on demand)) |
| cameraservice-0013 | mixed | behavior | 共享内存 InitShmem 是在哪里初始化的？ | cameraservice/policy/can/MWPCanInfo.cpp#InitShmem | cameraservice/policy/can/MWPCanInfo.h:42-42 (MWPCanInfo::InitShmem) / CLAUDE.md:1-236 (linux-mtk-mw-cameraservice 仓库架构概述 > 关键类) / park/i2c/MWPIICRxMgr.h:140-140 (MWPIICRxMgr::init) |
...
| cameraservice-0015 | mixed | path | 泊车页 logo 的绘制实现在哪个文件？ | park/render/MWPLogo.cpp | CLAUDE.md:1-236 (linux-mtk-mw-cameraservice 仓库架构概述 > 核心功能模块) / park/presenter/LogoPresenter.cpp:190-214 (LogoPresenter::OnTimerHandleFunc) / libcamera/MWPLogoFile.h:13-13 (LOGO_FINISH_PATH) |
