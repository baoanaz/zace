...
| 靶场名 | 仓库 | 规模 | 用例 |
|---|---|---|---|
| `leveldb-v1` | C++（152 文件） | 2642 chunks | 20（含 1 负例） |
| `helloagents-v1` | Python（236 文件） | 2729 chunks | 20（含 1 负例） |
| `langchain-v1` | Python（2950 文件） | 20673 chunks | 20（含 1 负例） |

源码 checkout 在 `~/2_github/AI/ACE/benchmark/<repo>`。
