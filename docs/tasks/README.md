...
| [TASK-097](TASK-097-索引白名单.md) | **索引白名单**（第 0 层，强制包含 AI 指令文档 + `skills/` 目录；不影响内置剪枝） | TASK-037 ✅ | `core/zace_core/pipeline/ignore.py`、`parsing/markdown.py`、`client/src/ignore.rs`、`docs/handbook/` | **review（lane H，待契约更新 R42）** |
