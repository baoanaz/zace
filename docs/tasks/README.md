...
| [TASK-080](TASK-080-接入指南两卡牌.md) | **接入指南重做**：两卡牌（npm 下载 + Agent 接入）+ 配置必带 `--token` | 无 | `web/src/app/connect-info.{ts,test.ts}`、`web/src/pages/ConnectPage.tsx`、`npm/README.md` | **review** |
