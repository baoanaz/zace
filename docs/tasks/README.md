...
| [TASK-096](TASK-096-预算计量与next_queries.md) | **预算计量修复（框架开销未计入 + 中文估算偏差）+ next_queries 从缺口出发** | 无（soft: TASK-095，同改 assembly.py） | `core/zace_core/contextpack/assembly.py`、`core/tests/contextpack/` | review |
